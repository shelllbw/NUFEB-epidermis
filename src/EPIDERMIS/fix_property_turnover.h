...
FixStyle(skin/property/turnover,FixPropertyTurnover)

#else

#ifndef LMP_FIX_PROPERTY_TURNOVER_H
#define LMP_FIX_PROPERTY_TURNOVER_H

#include "fix_property.h"

namespace LAMMPS_NS {

class FixPropertyTurnover : public FixProperty {
 public:

  FixPropertyTurnover(class LAMMPS *, int, char **);
  virtual ~FixPropertyTurnover();
